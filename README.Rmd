...
knitr::kable(ex_rates, caption = "Table numbers for historical exchange rate tables")
```
...
knitr::kable(nonreadable, caption = "Tables not currently readable with `read_rba()`")
```
